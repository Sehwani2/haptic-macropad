...
During the initial startup calibration, the motor occasionally experienced high-frequency vibration or failure to align. 
This happened when the rotor was accidentally positioned at a 180° electrical angle relative to the target vector—creating a physical equilibrium dead-lock—or due to raw register noise from the encoder on power-up.
