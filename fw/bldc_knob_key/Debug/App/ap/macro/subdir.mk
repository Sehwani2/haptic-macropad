...
C_SRCS += \
../App/ap/macro/macro.c 

OBJS += \
./App/ap/macro/macro.o 

C_DEPS += \
./App/ap/macro/macro.d 


# Each subdirectory must supply rules for building sources it contributes
App/ap/macro/%.o App/ap/macro/%.su App/ap/macro/%.cyclo: ../App/ap/macro/%.c App/ap/macro/subdir.mk
...
clean: clean-App-2f-ap-2f-macro

clean-App-2f-ap-2f-macro:
	-$(RM) ./App/ap/macro/macro.cyclo ./App/ap/macro/macro.d ./App/ap/macro/macro.o ./App/ap/macro/macro.su

.PHONY: clean-App-2f-ap-2f-macro
